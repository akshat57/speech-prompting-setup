class Checkpoint:
    def __init__(self, name, remote_path, fname, sha256):
        self.name = name
...
def populate_checkpoints():
    ...
    for checkpoint in checkpoints:
        all_checkpoints[checkpoint.name] = (checkpoint.remote_path, checkpoint.fname, checkpoint.sha256)


    twist_lms = {
        'TWIST-350M': 'https://dl.fbaipublicfiles.com/textless_nlp/twist/lms/TWIST-350M.zip',
        'TWIST-1.3B': 'https://dl.fbaipublicfiles.com/textless_nlp/twist/lms/TWIST-1.3B.zip',
        'TWIST-7B': 'https://dl.fbaipublicfiles.com/textless_nlp/twist/lms/TWIST-7B.zip'
    }


    return all_checkpoints, twist_lms

all_checkpoints, twist_lms = populate_checkpoints()
